        ...
        {groupedExercises.map((groupedExercise, idx) => {
          ...
          return (
            <div
              ...
              className="bg-slate-800/20 p-3 rounded-lg relative"
            >
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {groupedExercise.sets.map((set, setIdx) => (
                  <span
                    key={setIdx}
                    className="text-xs bg-slate-900/50 px-2 py-1 rounded border border-gray-200"
                  >
              ...
              {groupedExercise.notes.length > 0 && (
                <div className="mt-2 text-xs text-slate-400 italic space-y-1">
...
function MultiDeleteModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-slate-900/50 rounded-lg p-6 max-w-lg w-full mx-4">
